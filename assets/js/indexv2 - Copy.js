...
if(getCurrentTheme() == "dark"){
  document.getElementById("nav__logo").src="assets/img/logo/QB logo light.png"
  document.getElementById("nav__logo_price").src="assets/img/logo/QB logo light.png"
  ...
  document.getElementById("nav__logo").src="assets/img/logo/QB logo Main.png"
  document.getElementById("nav__logo_price").src="assets/img/logo/QB logo Main.png"
